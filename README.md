...
초안 작성
### 설치 방법
1. index.html 파일을 텍스트 편집기로 실행 시 서비스를 이용하실 수 있습니다.
2. index.html 파일을 chrome 등 브라우저로 실행도 가능합니다.
3. https://fkwmqpfl01.github.io/web_project/ 를 통해서도 서비스를 이용하실 수 있습니다.
### 기본 사용 예시
사용 시나리오는 간단합니다.  
